---
title: "Day 2 - Module XX: DESeq2 Differential Expression"
...
![*Figure credit to [HBC  training materials](https://hbctraining.github.io/DGE_workshop/lessons/02_DGE_count_normalization.html)*](./images/normalization_methods_composition.png)
...
**TODO: Add popout note about rlog versus vst transformation?**
...
resultsNames(dds) #includes three pairwise comparison to specified control as default but other information is stored in object so can generate additional pairwise comparisons
```
