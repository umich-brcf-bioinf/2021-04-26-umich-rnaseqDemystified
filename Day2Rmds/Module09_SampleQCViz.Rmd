---
title: "Day 2 - Module XX: Sample Visualizations"
...
We'll generate the PCA projections for the top 500 using the `plotPCA` function from DESeq2. 
```{r PCArlog3}
p.all <- plotPCA(rld, intgroup = c('Gtype.Tx'), ntop = 500)
p.all
```

Next, we'll save this plot to file. **TODO: Check that this  works**
```{r PCArlog1}
...
**TODO: Format as popout bonus section**
